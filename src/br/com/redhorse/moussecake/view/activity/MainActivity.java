...
ActionBar.TabListener {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.action_menu).toUpperCase(l);
			case 1:
				return getString(R.string.action_pedidos).toUpperCase(l);
			case 2:
				return getString(R.string.action_conta).toUpperCase(l);
			}
			return null;
		}
	}
